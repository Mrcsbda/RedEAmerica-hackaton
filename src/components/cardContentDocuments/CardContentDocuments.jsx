  ...
  return (
    <Card sx={{ maxWidth: 160 }}>
      <CardActionArea>
        ...
        <CardContent>
          <Typography gutterBottom variant="p" component="div" sx={{ overflow: 'hidden', display: '-webkit-box', WebkitBoxOrient: 'vertical', WebkitLineClamp: 4, textOverflow: 'ellipsis' }}>
            {title}
          </Typography>
