...
const EditPost = () => {
  ...
  const editPost = async(data) => {
    ...
    try {
      ...
      Swal.fire(
        "",
        "Haz actualizado el post correctamente",
        "success"
      )
    } catch (error) {
      console.log(error);
    ...
    <article className='contact-form'>
      <section className='contact-form__card'>
        ...
        <form className='contact-form__form' onSubmit={handleSubmit(editPost)}>
          ...
          >
            Logo <VisuallyHiddenInput type="file"/>
          </Button>
          <TextField
            label="Contenido"
            multiline
          ...
          <Autocomplete
            ...
            options={categories}
            renderInput={(params) => (
              <TextField {...params} defaultValue={post?.typeFormat} label="Tipo de Formato" variant="standard" className='contact-form__input' />
            )}
          />
            <Button
            component="label"
